...
import io.realm.todo.transactions.TransactionsActivity;
...
public class WelcomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		usernameView.setText("egis3");
		passwordView.setText("egistest");
    }
    ...
    private void setUpRealmAndGoToTaskListActivity() {
        ...
        Intent intent = new Intent(WelcomeActivity.this, TransactionsActivity.class);
