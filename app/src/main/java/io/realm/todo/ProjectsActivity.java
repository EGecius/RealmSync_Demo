...
public class ProjectsActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        findViewById(R.id.fab).setOnClickListener(view -> {
            ...
            new AlertDialog.Builder(ProjectsActivity.this)
                    ...
                    .setPositiveButton("Add", (dialog, which) -> realm.executeTransactionAsync(realm -> {
                    	...
                    	Log.e("Eg:ProjectsActivity:72", "onCreate error:" + error);
        ...
        realm = Realm.getInstance(getTransactionsRealmConfig());
	...
	private RealmConfiguration getTransactionsRealmConfig() {
		SyncUser user = SyncUser.current();
		String instance = Constants.INSTANCE_ADDRESS;
		String url = "realms://" + instance + "/~/Transactions";
		return user.createConfiguration(url).build();
	}

	private void printChangesInRealm(final RealmResults<Project> projects) {
		projects.addChangeListener(projects1 -> {
			String asJSON = projects1.asJSON();
			Log.i("Eg:ProjectsActivity:90", "onCreate asJSON:" + asJSON);
		});
	}
